...
import static jdbc.JdbcHelper.getOracleType;
...
public class JdbcTemplate extends org.springframework.jdbc.core.JdbcTemplate {
    ...
    public <T> T queryForObject(String sql, Object[] args, Class<T> requiredType) throws DataAccessException {
        if (sql.startsWith("call ")) {
            T results = call_sp(sql, args, requiredType);
            return results;
        } else {
            return super.queryForObject(sql, args, new SingleColumnRowMapper<T>(requiredType));
        }
    }
    ...
    public Map<String, Object> queryForMap(String sql, Object[] args) throws DataAccessException {
        if (sql.startsWith("call ")) {
            List results = call_sp(sql, args, List.class);
    ...
    public int update(final String sql, Object... args)
            throws DataAccessException {
        if (sql.startsWith("call ")) {
            Integer results = call_sp(sql, args, Integer.class);
            return results;
        } else {
